...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        Dim ListViewItem1 As ListViewItem = New ListViewItem(New String() {"test", "10000"}, -1)
        Dim ListViewItem2 As ListViewItem = New ListViewItem(New String() {"test2", "20000"}, -1)
        ...
        menuList.Items.AddRange(New ListViewItem() {ListViewItem1, ListViewItem2})
